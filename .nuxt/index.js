...
import nuxt_plugin_plugin_18fce44a from 'nuxt_plugin_plugin_18fce44a' // Source: .\\components\\plugin.js (mode: 'all')
import nuxt_plugin_vuescrollto_d1cfac6a from 'nuxt_plugin_vuescrollto_d1cfac6a' // Source: .\\vue-scrollto.js (mode: 'client')
...
async function createApp(ssrContext, config = {}) {
  ...
  if (typeof nuxt_plugin_plugin_18fce44a === 'function') {
    await nuxt_plugin_plugin_18fce44a(app.context, inject)
  }

  if (process.client && typeof nuxt_plugin_vuescrollto_d1cfac6a === 'function') {
    await nuxt_plugin_vuescrollto_d1cfac6a(app.context, inject)
  }
